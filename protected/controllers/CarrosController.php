...
class CarrosController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Carros']))
		{
		    ...
		    if ($image != null) {
                $name = md5(time() . rand(0, 9999)).'.'.$image->getExtensionName();
                $image->saveAs(Yii::app()->basePath.'/../images/'.$name);
                $model->foto = $name;
            }
	...
	{
		$dataProvider=new CActiveDataProvider('Carros');
